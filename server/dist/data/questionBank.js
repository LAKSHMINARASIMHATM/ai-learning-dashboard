...
exports.getQuestionsByDifficulty = exports.getQuestionsByTopic = exports.allQuestions = exports.cssQuestions = exports.nodejsQuestions = exports.typescriptQuestions = exports.reactQuestions = exports.javascriptQuestions = void 0;
// ============================================
// JAVASCRIPT QUESTIONS (25 questions)
// ============================================
exports.javascriptQuestions = [
    // Beginner
    {
        questionId: 'js-var-1',
...
exports.allQuestions = {
    javascript: exports.javascriptQuestions,
    react: exports.reactQuestions,
    typescript: exports.typescriptQuestions,
    nodejs: exports.nodejsQuestions,
    css: exports.cssQuestions,
};
const getQuestionsByTopic = (topic) => {
    const topicLower = topic.toLowerCase();
    if (topicLower.includes('javascript') || topicLower === 'js')
        return exports.javascriptQuestions;
    if (topicLower.includes('react'))
        return exports.reactQuestions;
    if (topicLower.includes('typescript') || topicLower === 'ts')
        return exports.typescriptQuestions;
    if (topicLower.includes('node') || topicLower.includes('api'))
        return exports.nodejsQuestions;
    if (topicLower.includes('css'))
        return exports.cssQuestions;
    return [];
};
